...
class TranslationsTest < ApplicationSystemTestCase
  ...
  test "should create translation" do
    ...
    fill_in "Blkc", with: @translation.blkc
    fill_in "Descrip", with: @translation.descrip
    fill_in "Lan", with: @translation.lan
    check "Li" if @translation.li
    fill_in "Message", with: @translation.message_id
    fill_in "Pubdate", with: @translation.pubdate
    fill_in "Senc", with: @translation.senc
    fill_in "Subc", with: @translation.subc
    fill_in "Tran title", with: @translation.tran_title
    fill_in "Version", with: @translation.version
    fill_in "Xcrip", with: @translation.xcrip
